 ...
 * src: //www.xinhuanet.com/global/public/wxShare.js
 * bk: //www.xinhuanet.com/global/public/wxShare.bk.js
 */
 ...
 var json_wx = {
     'jsonpurl': (function (callback) {
         ////api.home.news.cn/wx/jsapi.do?callback=sdfsdf&mpId=367&url=http%3A%2F%2Fapp.news.cn%2Fweixintest%2F;
         var str,
             //  loc = wxShareHref;
             //str = "//api.home.news.cn/wx/jsapi.do?callback=" + "cb" + "&mpId=367&url=" + loc;
 
             loc = wxShareHref.substring(0, wxShareHref.indexOf('#') < 0 ? undefined : wxShareHref.indexOf('#'));
         //str = "//api.home.news.cn/wx/jsapi.do?callback=" + "cb" + "&mpId=368&url=" + loc + '&t=' + new Date().getTime();
         str = "//api.home.news.cn/wx/jsapi.do?callback=cb" + "&mpId=376&url=" + encodeURIComponent(loc);
         return str;
     })(),
